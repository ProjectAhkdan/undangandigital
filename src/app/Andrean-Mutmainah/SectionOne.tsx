...
export default function SectionOne() {
  return (
    <div className="relative flex text-white font-poppins flex-col items-center justify-center h-screen max-w-md m-auto overflow-hidden bg-[#637f94] bg-noise p-2 text-center">
      <div>
        <Image
